    ...
    public static class ListUtility
    {
        ...
        public static bool Contains<T>(this IList<T> arr, T element) where T : class
        {
            for (int i = 0; i < arr.Count; i++) {
                if (Equals(arr[i], element)) { return true; }
            }
        ...
        /// <summary>
        /// Index of object within the list.
        /// </summary>
        /// <param name="self">The read only list.</param>
        /// <param name="elementToFind">The element to find in the list.</param>
